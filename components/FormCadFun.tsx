    ...
    return(
        <div className="relative w-[100%] flex p-9">
            ...
            <form onSubmit={(e)=>handelSubmit(e)}  data-aos='fade-down' className="flex flex-col  text-[#000] p-20 w-full  justify-center items-center ">
                ...
                <div className="w-full flex px- gap-9">
                <select className="p-2 mb-4 rounded-3xl hover:scale-110 w-[100%] bg-transparent border border-fuchsia-300 text-white" onChange={(e)=>handelChange(e)} name="turmas" id="">
                <option className="p-2 mb-4 rounded-3xl hover:scale-110 w-[100%] bg-black border border-fuchsia-300 text-white">Turmas</option>
               ...
               <select className="p-2 mb-4 rounded-3xl hover:scale-110 w-[100%] bg-transparent border border-fuchsia-300 text-white" onChange={(e)=>handelChange(e)} name="funcoes" id="">
                <option className="p-2 mb-4 rounded-3xl hover:scale-110 w-[100%] bg-black border border-fuchsia-300 text-white">Funcoes</option>
                <option className="p-2 mb-4 rounded-3xl  w-[100%]  border border-fuchsia-300 text-white bg-black" value="Professor">Professor</option>
                <option className="p-2 mb-4 rounded-3xl  w-[100%]  border border-fuchsia-300 text-white bg-black " value="Administrativo">Administrativo</option>
                <option className="p-2 mb-4 rounded-3xl  w-[100%]  border border-fuchsia-300 text-white bg-black" value="Limpeza">Limpeza</option>
                </select>

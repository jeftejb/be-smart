...
export default function Cursos({id}:Props){
    return(

        titleModels.map((item, index)=>{
          
            return(
            <Link href={`/perfil/${item.link}/${id}/${item.nivel}`} className=" relative w-full h-[450px] hover:scale-110 duration-100 rounded-tl-3xl rounded-tr-3xl">
         ...
         />
            ...
            <div className="relative w-full mt-4">
                <div className=" relative flex justify-between mx-4">
                 <h1 className="text-xl " >Nivel: <span className="text-green-500">{item.nivel}</span></h1>
                 ...
                 <div className="relative flex px-4 py-2 items-center justify-center gap-2 ">
                  <div className="absolute flex  w-full h-full  bg-green-500 brightness-50"/>
                    <h1 className=" relative overflow-visible">Desabilitado</h1>

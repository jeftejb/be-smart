        ...
        <section className="flex flex-col w-[100%] justify-center items-center h-[100%]">
            ...
            <div className="relative flex flex-col p-20 max-sm:p-8 w-[90%] mt-28 rounded-lg bg-[#00303C] items-center">
               ...
               <div className="flex flex-row max-sm:flex-col mt-2 gap-8">
                <p className="text-[12px] font-medium uppercase">Valor total a ser processado: <span className="text-yellow-600 font-bold">120.000,00Kz</span></p>
                <p  className="text-[12px] font-medium uppercase">Ano lectivo de pagamento : <span className="text-green-600 font-bold">Abril/2024</span></p>
                <p  className="text-[12px] font-medium uppercase ">Valor total já processado: <span className="text-yellow-300 font-bold">1.000.000,00Kz</span> </p>
               </div>
                </div> 

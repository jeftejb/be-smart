    ...
    return(
        <section className="relative w-full h-full top-0 left-0">
            ...
            <section className="w-full h-full flex flex-col mt-24 px-12 max-sm:px-4 py-28 items-center justify-center ">
                <h1 className="text-center my-10 text-2xl font-bold">Pagamento de Propinas de : <span className="text-gray-500" >@</span> <span className="text-green-500 text-xl "> Nome do estudante</span></h1>

                <Link href={`/perfil/estudante/${id}`} className="px-[20px] py-[2px] bg-green-300 text-black rounded-2xl mb-[20px]">Historico de pagamentos</Link>
               
                  <div className="flex flex-col w-full h-full max-md:grid-cols-1   gap-2 px-36  ">
                     ...
                     <form action="" data-aos='fade-down' className="flex flex-col  text-[#000] py-7 px-20 w-full  justify-center items-center ">
                           ...
                           <div className=" relative flex flex-col w-full h-80 my-2 mx-8 py-2 px-8 ">
                            <div className=" absolute left-8 top-0 flex flex-col  w-[50%] h-full " >
                            <label htmlFor="recibo" className="text-white  font-bold mb-3 " >Selecione a imagem do comprovativo</label>
                              <input type="file" name="" id="recibo" className="text-white px-4 py-2 border-2 border-green-300  rounded-2xl mt-4 " />
                            </div>
                            

                              <div className=" absolute w-72 h-72 top-0 right-4 border-2 border-green-500 rounded-xl">

                              </div>
                           </div>
 
                     <select className="p-2 mb-4 rounded-3xl hover:scale-110 w-[100%] bg-transparent border-2 border-green-500 text-white bg-black" name="" id="">
                    <option className="p-2 mb-4 rounded-3xl  w-[100%]  border-2 border-green-500 text-white bg-black" value={""} >Messes a pagar</option>
                    <option className="p-2 mb-4 rounded-3xl  w-[100%]  border-2 border-green-500 text-white bg-black" value={1}>  1 - Mês</option>
                    <option className="p-2 mb-4 rounded-3xl  w-[100%]  border-2 border-green-500 text-white bg-black " value={2}> 2 - Mêses</option>
                    <option className="p-2 mb-4 rounded-3xl  w-[100%]  border-2 border-green-500 text-white bg-black " value={3}> 3 - Mêses</option>
                    <option className="p-2 mb-4 rounded-3xl  w-[100%]  border-2 border-green-500 text-white bg-black " value={4}> 4 - Mêses</option>
                    <option className="p-2 mb-4 rounded-3xl  w-[100%]  border-2 border-green-500 text-white bg-black " value={5}> 5 - Mêses</option>
                    <option className="p-2 mb-4 rounded-3xl  w-[100%]  border-2 border-green-500 text-white bg-black " value={6}> 6 - Mêses</option>
                    <option className="p-2 mb-4 rounded-3xl  w-[100%]  border-2 border-green-500 text-white bg-black " value={7}> 7 - Mêses</option>
                    <option className="p-2 mb-4 rounded-3xl  w-[100%]  border-2 border-green-500 text-white bg-black " value={8}> 8 - Mêses</option>
                    <option className="p-2 mb-4 rounded-3xl  w-[100%]  border-2 border-green-500 text-white bg-black " value={9}> 9 - Mêses</option>
                    <option className="p-2 mb-4 rounded-3xl  w-[100%]  border-2 border-green-500 text-white bg-black " value={10}> 10 - Mêses</option>
               </select>
               <h1 className="text-center text-white">Meses a pagar </h1>
                ...
                <button className="px-5 py-2 border border-green-500  text-white mt-2 hover:bg-green-300 hover:text-black ">Efectuar pagamento</button>

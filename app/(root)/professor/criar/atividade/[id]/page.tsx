...
export default function Page({params}:{params:{id:string}}){
    ...
    return(
        ...
        <section className="relative flex w-full h-full top-0 left-0 ">
         ...
         <form className="w-full f-full py-9 ">
        ...
        <div className="relative flex flex-col h-full w-fuill py-9 px-20 gap-4  ">
          ...
          <div className="absolute w-[90%] h-full gap-9  py-10 contrast-[.10] ">
           ...
           <div className=" relative flex flex-col w-full h-full  gap-9 py-10  items-center justify-center  ">
            <h1 className="text-black text-3xl text-center my-4 font-bold">Atividade: <span>nome da atividade</span></h1>

            <input type="text" placeholder="Digite o nome da atividade" className="w-60 h-8" />
            ...
            <div className="flex flex-col border-2 border-black items-center justify-center gap-9 p-9 mx-10 ">
                ...
                <div className="w-fll h-full ">
                    ...
                    <input type="text" name="" id="texto" placeholder="Digite o texto " />
                </div>
            </div>

            {/** selecao multipla */}

            <div className="flex flex-col border-2 border-black items-center justify-center gap-9 p-9 mx-10 w-[95%] h-full ">
                <h1 className="text-black text-4xl font-bold">Titulo</h1>
                <div className="w-full h-full flex">
                    <label htmlFor="tituloP1">Titulo</label>
                    <input type="text" name="" id="tituloP1" placeholder="Digite o titulo da questao" />
                </div>

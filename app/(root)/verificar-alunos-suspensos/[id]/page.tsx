...
import {fetchAlunosAllEnable, getFullNumberStudentEnabled } from "@/lib/actions/alunos.actions";
...
import Link from "next/link";
   ...
   async function getData(perPage:number, page:number){
    ...
    try {
        const alunos = await fetchAlunosAllEnable(perPage, page);
        const countAll = await getFullNumberStudentEnabled();
    ...
    return(
        <div className="relative flex w-[100%] h-[100%] top-0 left-0 items-center justify-center">
            ...
            <div className="w-[80%] bg-[#00303C] mt-[200px] p-[12px] flex flex-col  gap-3 items-center  rounded-xl">
                ...
                <h1 className="w-full text-center text-[18px] text-[#6BA614] font-bold p-[20px]">Alunos Suspensos</h1>
